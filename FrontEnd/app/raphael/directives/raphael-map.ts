...
angular.module('app.raphael').directive('raphaelMap', [
    'raphaelMaps', 'raphaelMapCreator', 'raphaelColorScale',
    (
        raphaelMaps: any,
        raphaelMapCreator: app.raphael.RaphaelMapCreator,
        raphaelColorScaleFactory: app.raphael.IRaphaelColorScaleFactory) => {
    ...
    return {
            ...
            link: function (scope, element, attrs) {
                ...
                var map = _.find(raphaelMaps, (b: any) => {
